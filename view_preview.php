...
$formurl = new moodle_url('view_preview.php', $paramurl);
...
if ($userpage_manager->formdata = $dataentry_form->get_data()) {
    ...
    if ($prevbutton) {
        ...
        redirect(new moodle_url('view_preview.php', $paramurl)); // -> go to the first non empty previous page of the form
    }
    ...
    if ($nextbutton) {
        ...
        redirect(new moodle_url('view_preview.php', $paramurl)); // -> go to the first non empty next page of the form
    }
}
...
$userpage_manager->explicit_explore_mode();
