 ...
 */
function xmldb_surveytemplate_surveyTemplatePluginNamePlaceholder_install() {
 ...
 */
function xmldb_surveytemplate_surveyTemplatePluginNamePlaceholder_install_recovery() {
    //global $CFG, $DB;
