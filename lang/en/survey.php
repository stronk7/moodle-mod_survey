...
$string['hassubmissions_detail'] = 'This survey has already been submitted at least once.<br />Please proceed with extreme caution and make only minimal changes to not compromise the validity of the whole survey.';
$string['hassubmissions_general'] = 'This survey has already been submitted at least once.<br />You are definitly not allowed to add new items.';
...
$string['parentid'] = 'Parent question type element';
$string['pause'] = 'Pause';
