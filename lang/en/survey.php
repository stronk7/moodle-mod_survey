...
$string['tabitemname'] = 'Elements';
    ...
    $string['tabitemspage2'] = 'Setup';
    $string['tabitemspage3'] = 'Validate branching';
...
$string['askitemsshow'] = 'Showing the element {$a->lastitem} you are going to show all its ancestors.<br />Ancestors are elements in position: {$a->ancestors}.<br />Do you confirm this action?';
...
$string['limitedaccess'] = 'Advanced item';
