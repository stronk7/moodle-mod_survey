...
$string['denyinstantiation_descr'] = 'Deny instantiation of this master template because a new release already exists and this one is here only for backword compatibility feeding its old instances.';
