...
$string['applyutemplateinfo'] = 'You can enrich your survey applying set of elements taken from an XML user template<br /><strong>Be warned: by setting "{$a->usertemplate}" to "{$a->none}" and "{$a->actionoverother}" to "{$a->deleteallitems}" you bring your survey back to just created state</strong>';
...
$string['multilangrestored'] = 'Multilang content has been restored for this element';
$string['aaa'] = 'bbb';
$string['aaa'] = 'bbb';
$string['aaa'] = 'bbb';
$string['aaa'] = 'bbb';
