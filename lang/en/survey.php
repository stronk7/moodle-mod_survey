...
$string['tabsubmissionsname'] = 'Survey';
    $string['tabsubmissionspage1'] = 'Explore';
...
$string['tabitemname'] = 'Survey elements';
...
$string['fillinginstructioninsearch_descr'] = 'Are instruction guides needed in the search form?';
$string['fillinginstructioninsearch'] = 'Instruction guides in search form';
...
$string['extranote_help'] = 'Write here a description/note about extra informations the user is supposed to know about this field.';
$string['extranote'] = 'Question notes';
$string['extranoteinsearch_descr'] = 'Are user notes needed in the search form?';
$string['extranoteinsearch'] = 'Soft infos in search form';
...
$string['exploremode'] = 'You are in explore mode: buttons for data saving are not supposed to display';
$string['hideinstructions'] = 'Hide filling instruction';
$string['hideinstructions_help'] = 'Use this checkbox to show/hide filling instruction for this field';
$string['aaa'] = 'bbb';
$string['aaa'] = 'bbb';
$string['aaa'] = 'bbb';
$string['aaa'] = 'bbb';
