...
function xmldb_surveyfield_time_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_time to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'time');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_time.
        $table = new xmldb_table('survey_time');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_time');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'time');
    }
