...
function xmldb_surveyfield_time_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field contentformat to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field customnumber to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field extrarow to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field extranote to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field required to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field hideinstructions to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field variable to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Define field indent to be added to survey_time.
        $table = new xmldb_table('survey_time');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'time');
    }
