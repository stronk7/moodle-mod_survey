...
function xmldb_surveyfield_date_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_date to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'date');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_date.
        $table = new xmldb_table('survey_date');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_date');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'date');
    }
