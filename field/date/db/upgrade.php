...
function xmldb_surveyfield_date_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field contentformat to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field customnumber to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field extrarow to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field extranote to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field required to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field hideinstructions to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field variable to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Define field indent to be added to survey_date.
        $table = new xmldb_table('survey_date');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'date');
    }
