...
function xmldb_surveyfield_recurrence_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_recurrence to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'recurrence');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_recurrence.
        $table = new xmldb_table('survey_recurrence');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_recurrence');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'recurrence');
    }
