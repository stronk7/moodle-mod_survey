...
function xmldb_surveyfield_datetime_upgrade($oldversion) {
    ...
    if ($oldversion < 2013052302) {
        // Define field downloadformat to be added to survey_datetime.
    ...
    if ($oldversion < 2013052401) {
        // Changing type of field downloadformat on table survey_datetime to char.
        $table = new xmldb_table('survey_datetime');
        ...
        // set default
        $DB->set_field('survey_datetime', 'downloadformat', 'strftime01');
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field contentformat to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field customnumber to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field extrarow to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field extranote to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field required to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field hideinstructions to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field variable to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Define field indent to be added to survey_datetime.
        $table = new xmldb_table('survey_datetime');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'datetime');
    }
