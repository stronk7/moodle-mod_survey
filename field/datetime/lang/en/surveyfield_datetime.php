...
$string['strftime0'] = '%A, %d %B %Y, %H:%M';
$string['strftime1'] = '%A, %d %B %Y, %I:%M %p';
$string['strftime2'] = '%a, %d %b %Y, %I:%M %p';
$string['strftime3'] = '%a, %d %b %Y, %H:%M';
$string['strftime4'] = '%d %B %Y, %H:%M';
$string['strftime5'] = '%d %B %Y, %I:%M %p';
$string['strftime6'] = '%d %b, %H:%M';
$string['strftime7'] = '%d %b, %I:%M %p';
$string['strftime8'] = '%d/%m/%y, %I:%M %p';
$string['strftime9'] = '%d/%m/%y, %H:%M';
