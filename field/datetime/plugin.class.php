...
class surveyfield_datetime extends mod_survey_itembase {
    ...
    public function item_get_downloadformats() {
        ...
        for ($i = 1; $i < 13; $i++) {
            ...
            $option[$strname] = userdate($timenow, get_string($strname, 'surveyfield_datetime')); // Monday 17 June, 05.15
        }
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
    <xs:element name="surveyfield_datetime">
        <xs:complexType>
            <xs:sequence>
...
EOS;
    ...
    public function userform_mform_validation($data, &$errors, $survey, $searchform) {
        ...
        if (!$searchform) {
            ...
            // all five drop down menues are allowed to be == SURVEY_IGNOREME
            ...
            if ($data[$this->itemname.'_day'] == SURVEY_IGNOREME) {
                ...
                $testpassed = $testpassed && ($data[$this->itemname.'_hour'] == SURVEY_IGNOREME);
