...
function xmldb_surveyfield_checkbox_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_checkbox to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'checkbox');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_checkbox');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'checkbox');
    }
