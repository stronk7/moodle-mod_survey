...
function xmldb_surveyfield_checkbox_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field contentformat to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field customnumber to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field extrarow to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field extranote to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field required to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field variable to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Define field indent to be added to survey_checkbox.
        $table = new xmldb_table('survey_checkbox');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'checkbox');
    }
