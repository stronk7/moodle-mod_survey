...
function xmldb_surveyfield_numeric_upgrade($oldversion) {
    ...
    if ($oldversion < 2013072401) {
        ...
        // Define field defaultvalue_sid to be dropped from survey_numeric.
        $table = new xmldb_table('survey_numeric');
        $field = new xmldb_field('defaultvalue_sid');

        // Conditionally launch drop field defaultvalue_sid.
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field contentformat to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field customnumber to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field extrarow to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field extranote to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field required to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field hideinstructions to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field variable to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Define field indent to be added to survey_numeric.
        $table = new xmldb_table('survey_numeric');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'numeric');
    }
