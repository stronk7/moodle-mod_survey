...
function xmldb_surveyfield_fileupload_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_fileupload.
        ...
        // Define field contentformat to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        // Define field customnumber to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        // Define field extrarow to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        // Define field extranote to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        // Define field required to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        // Define field variable to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        // Define field indent to be added to survey_fileupload.
        $table = new xmldb_table('survey_fileupload');
        ...
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'fileupload');
    }
