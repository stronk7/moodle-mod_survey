...
/*
 * Strings for component 'field_fileupload', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    survey
...
$string['allowedtypes_help'] = 'The comma separated list of allowed file extension';
$string['allowedtypes'] = 'Allowed file types (comma separated)';
