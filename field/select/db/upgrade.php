...
function xmldb_surveyfield_select_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_select to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'select');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_select.
        $table = new xmldb_table('survey_select');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_select');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'select');
    }
