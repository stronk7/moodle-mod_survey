...
function xmldb_surveyfield_select_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field contentformat to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field customnumber to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field extrarow to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field extranote to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field required to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field variable to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Define field indent to be added to survey_select.
        $table = new xmldb_table('survey_select');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'select');
    }
