...
function xmldb_surveyfield_boolean_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_boolean to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'boolean');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_boolean.
        $table = new xmldb_table('survey_boolean');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_boolean');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'boolean');
    }
