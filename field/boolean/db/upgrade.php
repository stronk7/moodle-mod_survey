...
function xmldb_surveyfield_boolean_upgrade($oldversion) {
    ...
    if ($oldversion < 2013061801) {
        ...
        // set default
        $DB->set_field('survey_boolean', 'downloadformat', 'strfbool01');
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field contentformat to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field customnumber to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field extrarow to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field extranote to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field required to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field variable to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Define field indent to be added to survey_boolean.
        $table = new xmldb_table('survey_boolean');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'boolean');
    }
