...
/*
 * Strings for component 'field_boolean', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    survey
 * @subpackage boolean
...
$string['strfbool1'] = 'yes/no';
$string['strfbool2'] = 'y/n';
$string['strfbool3'] = 'Y/N';
$string['strfbool4'] = 'up/down';
$string['strfbool5'] = 'true/false';
$string['strfbool6'] = 'T/F';
$string['strfbool7'] = '1/0';
$string['strfbool8'] = '+/-';
