...
function xmldb_surveyfield_radiobutton_upgrade($oldversion) {
    ...
    if ($oldversion < 2013073001) {
        ...
        // Define field content_sid to be dropped from survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Define field contentformat to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Define field customnumber to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Define field extrarow to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Define field extranote to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Define field required to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Define field indent to be added to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'radiobutton');
    }
