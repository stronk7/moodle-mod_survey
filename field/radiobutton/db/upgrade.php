...
function xmldb_surveyfield_radiobutton_upgrade($oldversion) {
    ...
    if ($oldversion < 2013100601) {
        ...
        // Rename field extrarow on table survey_radiobutton to position.
        ...
        upgrade_plugin_savepoint(true, 2013100601, 'surveyfield', 'radiobutton');
    }

    if ($oldversion < 2013103101) {

        // Define table survey_age to be renamed to survey_radiobutton.
        $table = new xmldb_table('survey_radiobutton');

        // Launch rename table for survey_age.
        $dbman->rename_table($table, 'surveyfield_radiobutton');

        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013103101, 'surveyfield', 'radiobutton');
    }
