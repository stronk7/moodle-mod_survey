...
$string['ierr_maxexceeds'] = 'Maximum length has to be lower than 256 characters';
$string['ierr_toolongdefault'] = 'Default has to be shorter than maximum allowed length';
$string['ierr_tooshortdefault'] = 'Default has to be longer than minimum allowed length';
$string['ierr_nopatternmatch'] = 'Default does not match the required pattern';
$string['ierr_toolongpattern'] = 'Pattern has to be shorter than maximum allowed length';
$string['ierr_tooshortpattern'] = 'Pattern has to be longer than minimum allowed length';
