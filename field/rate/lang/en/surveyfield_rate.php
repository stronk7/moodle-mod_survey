...
$string['forcedifferentrates_help'] = 'Force the user to rate each element with a different value';
$string['forcedifferentrates'] = 'Force different rates';
...
$string['downloadformat'] = 'Returned value';
...
$string['returnselection'] = 'list of values with corresponding rates';
