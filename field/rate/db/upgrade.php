...
function xmldb_surveyfield_rate_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field contentformat to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field customnumber to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field extrarow to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field extranote to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field required to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field variable to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Define field indent to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'rate');
    }

    if ($oldversion < 2013081902) {

        // Define field hideinstructions to be added to survey_rate.
        $table = new xmldb_table('survey_rate');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081902, 'surveyfield', 'rate');
    }
