 ...
 * @return bool true
 */
function xmldb_surveyfield_age_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_age.
        ...
        // Define field contentformat to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field customnumber to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field extrarow to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field extranote to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field required to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field hideinstructions to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field variable to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        // Define field indent to be added to survey_age.
        $table = new xmldb_table('survey_age');
        ...
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'age');
    }
