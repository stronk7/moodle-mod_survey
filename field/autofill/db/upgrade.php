...
function xmldb_surveyfield_autofill_upgrade($oldversion) {
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field contentformat to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field customnumber to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field extrarow to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field extranote to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field required to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field variable to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Define field indent to be added to survey_autofill.
        $table = new xmldb_table('survey_autofill');
        ...
        // Survey savepoint reached.
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'autofill');
    }
