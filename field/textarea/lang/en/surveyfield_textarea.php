...
/**
 * Strings for component 'field_textarea', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    survey
 * @subpackage item_textarea
...
$string['hasminmaxlength'] = 'Long text is supposed to fit between {$a} characters';
$string['hasminlength'] = 'Long text is supposed to be longer than {$a} characters';
$string['hasmaxlength'] = 'Long text is supposed to be shorter than {$a} characters';
$string['and'] = ' and ';
