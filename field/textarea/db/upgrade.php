...
/*
 * Keeps track of upgrades to the surveyitem textarea
 *
 * @package    surveyitem
 * @subpackage textarea
 ...
 * @return bool true
 */
function xmldb_surveyfield_textarea_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2013081901) {
        ...
        // Define field content to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field contentformat to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field customnumber to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field extrarow to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field extranote to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field required to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field hideinstructions to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field variable to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        // Define field indent to be added to survey_textarea.
        $table = new xmldb_table('survey_textarea');
        ...
        upgrade_plugin_savepoint(true, 2013081901, 'surveyfield', 'textarea');
    }
